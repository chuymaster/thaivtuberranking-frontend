...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get navigation_menu_info_site_description => 'Find your favorite Thai VTubers!';
  ...
  @override
  String get navigation_menu_menu_report_problems => 'Report Problems / Suggest Features';

  @override
  String get navigation_menu_menu_deletion_criterias => 'Automatic Channel Deletion Criterias';

  @override
  String get navigation_menu_menu_disclaimer => 'Disclaimer';

  @override
  String get navigation_menu_menu_discover_thai_vtuber => 'Discover Thai VTubers Info';
  ...
  @override
  String get announcement_text_delete_channel => 'Announcement regarding channel delete';
  ...
  @override
  String get banner_description_reality => 'Transform yourself and live like a VTuber!';
  ...
  @override
  String get channel_registration_complete_text_description => 'Thank you for submitting the channel. We will add it to the channel database after verification.';
  ...
  @override
  String get channel_registration_text_input_channel => 'Enter the channel ID, started with UC';

  @override
  String get channel_registration_text_select_channel_type => 'Select the channel type';

  @override
  String get channel_registration_text_check_before_submit => 'Please check the channel info again before submitting.';
  ...
  @override
  String get channel_registration_error_not_begin_with_uc => 'Channel ID must start with UC';
  ...
  @override
  String get channel_registration_error_already_existed => 'This channel is already in the database';

  @override
  String get channel_registration_error_unknown => 'There was a problem submitting data, please try again later';

  @override
  String get channel_registration_title_id_explanation => 'What is a Channel ID?';

  @override
  String get channel_registration_title_type_explanation => 'Types of channels allowed:';

  @override
  String get channel_registration_text_full_vtuber_explanation => '- Channels primarily featuring VTuber models (Live2D or 3D) from the first content and having a VTuber model as the main character of the content';

  @override
  String get channel_registration_text_all_vtuber_explanation => '- Channels that primarily feature VTuber models after having other contents for a period of time. These channels will only appear in the \'All VTubers\' category.';

  @override
  String get channel_registration_text_type_explanation => 'In both cases, the channels must be created by Thais, primarily targeting Thai audiences, and have uploaded some contents.';

  @override
  String get channel_registration_text_id_explanation_1 => 'Channel ID is the code following the URL of the channel, such as https://www.youtube.com/channel/';

  @override
  String get channel_registration_text_id_explanation_2 => 'You can check the channel ID from this site.';
  ...
  @override
  String get navigation_menu_text_original_description => 'Original VTuber\' refers to a channel that debuted and has been creating content as a VTuber from the beginning, rather than transitioning from other types of content.';

  @override
  String get navigation_menu_text_active_type => 'Activity Type';

  @override
  String get navigation_menu_text_active_type_explanation => 'Channels that have not uploaded a video for over 90 days are classified as inactive.';

  @override
  String get navigation_menu_radio_box_active_only => 'Active channels';

  @override
  String get navigation_menu_radio_box_active_and_inactive => 'Active and inactive channels';
  ...
  @override
  String get error_empty_channel_description => 'Unable to display information.\nPlease check your internet connection,\nor notify the developer to correct the issue';
