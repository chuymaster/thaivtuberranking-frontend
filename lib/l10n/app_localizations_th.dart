...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get navigation_menu_menu_report_problems =>
      'แจ้งปัญหา/แจ้งข้อมูลแชนแนลผิด/เสนอฟีเจอร์';

  @override
  String get navigation_menu_menu_deletion_criterias =>
      'เกณฑ์การลบแชนแนลโดยอัตโนมัติ';
  ...
  String get banner_description_reality =>
      'สร้างอวาตาร์อนิเมะมาไลฟ์แบบ VTuber เลย!';
  ...
  String get channel_registration_text_input_channel =>
      'โปรดกรอกแชนแนล ID (ขึ้นต้นด้วย UC)';
  ...
  String get channel_registration_text_check_before_submit =>
      'โปรดตรวจสอบแชนแนลอีกครั้งก่อนส่งข้อมูล';
  ...
  String get channel_registration_text_full_vtuber_explanation =>
      '- แชนแนลที่นำแสดงโดยโมเดล VTuber (โมเดล Live2D หรือ 3D) เป็นหลักตั้งแต่คอนเทนต์แรก มีโมเดล VTuber เป็นตัวเอกของคอนเทนต์ และประกาศตนว่าเป็น VTuber';

  @override
  String get channel_registration_text_all_vtuber_explanation =>
      '- แชนแนลที่นำโมเดล VTuber มาแสดงเป็นหลักหลังจากเปิดแชนแนลและอัพโหลดคอนเทนต์อื่นไปแล้ว จะปรากฏในการรายชื่อหมวด \"VTuber ทั้งหมด\" เท่านั้น';
  ...
  String get navigation_menu_text_original_description =>
      '\'VTuber เต็มตัว\' หมายถึงแชนแนลที่เดบิวต์ตัวเองเป็น VTuber และทำคอนเทนต์ VTuber ตั้งแต่ต้น ไม่ได้เปลี่ยนมาจากคอนเทนต์อื่น';
  ...
  String get error_empty_channel_description =>
      'เกิดข้อผิดพลาดจึงไม่สามารถแสดงข้อมูลได้\nกรุณาตรวจสอบการเชื่อมต่ออินเทอร์เน็ต\nหรือแจ้งผู้พัฒนาเพื่อทำการแก้ไข';
