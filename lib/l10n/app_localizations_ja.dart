...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get channel_registration_text_full_vtuber_explanation =>
      '・チャンネル開設時からVTuberモデル（Live2Dまたは3D）を使って動画を投稿し、主にVTuberとして活動しているチャンネル';

  @override
  String get channel_registration_text_all_vtuber_explanation =>
      '・一定期間の活動後、VTuberに転換したチャンネル。あるいはVTuberモデルを使って動画を投稿しているが、メインコンテンツではないチャンネル。「全てのVTuber」のカテゴリで表示されます。';

  @override
  String get channel_registration_text_type_explanation =>
      'いずれもタイ人によって制作され、タイ人を主な視聴者としているチャンネル、かつコンテンツがアップロードされている場合に限り、掲載が可能になります。';

  @override
  String get channel_registration_text_id_explanation_1 =>
      'チャンネルIDは、チャンネルURLに続くコードです。例：https://www.youtube.com/channel/';
  ...
  String get navigation_menu_text_original_description =>
      '「オリジナルVTuber」は、チャンネル開設時からVTuberとしてデビューし、コンテンツを制作しているチャンネルを指します。';
  ...
  String get navigation_menu_text_active_type_explanation =>
      '90日以上動画を投稿していないチャンネルは活動休止チャンネルとなります。';
